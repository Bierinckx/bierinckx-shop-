...
function go(lang,page){const map={'':'',shop:'shop',psy:'psychologie',cons:'consultancy',cro:'cro',graf:'grafische-nijverheid',ai:'ai-automatisering',chat:'klantenservice','shop-skincare':'skincare','shop-parfum':'parfum','shop-makeup':'make-up','shop-accessoires':'accessoires','shop-home':'home-wellness','shop-kleding':'kleding'};const frMap={psy:'psychologie',cons:'consultance',cro:'cro',graf:'industrie-graphique',ai:'automatisation-ia',chat:'service-client','shop-skincare':'soins','shop-parfum':'parfum','shop-makeup':'maquillage','shop-accessoires':'accessoires','shop-home':'maison-bien-etre','shop-kleding':'vetements'};const enMap={psy:'psychology',cons:'consultancy',cro:'cro',graf:'graphics-industry',ai:'ai-automation',chat:'customer-service','shop-skincare':'skincare','shop-parfum':'fragrance','shop-makeup':'make-up','shop-accessoires':'accessories','shop-home':'home-wellness','shop-kleding':'clothing'};const deMap={psy:'psychologie',cons:'consultancy',cro:'cro',graf:'grafikbranche',ai:'ki-automatisierung',chat:'kundenservice','shop-skincare':'hautpflege','shop-parfum':'parfum','shop-makeup':'make-up','shop-accessoires':'accessoires','shop-home':'home-wellness','shop-kleding':'kleidung'};let slug=map[page]||page;if(lang==='fr'&&frMap[page])slug=frMap[page];if(lang==='en'&&enMap[page])slug=enMap[page];if(lang==='de'&&deMap[page])slug=deMap[page];window.location.href='/'+lang+(slug?'/'+slug:'');}
