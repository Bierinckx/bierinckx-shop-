var T = {
  nl: {
    ...
    hero:{tag:"Onafhankelijk luxe-advies · BE / NL / FR / DE",h1b:"Luxe voor",h1c:"het hele gezin",sub:"Van baby tot senior: AURA LUXE selecteert zorgvuldig kleding, verzorging, geur en accessoires bij topretailers als Douglas, Zalando, Rituals en Lookfantastic — zodat elk gezinslid de beste keuze maakt, tegen de beste prijs.",cta1:"Bekijk de collectie",cta2:"Hoe wij werken"},
    cats:["Baby & Peuter","Kids","Tieners","Volwassenen","Senioren","Home & Wellness"],
    catDesc:["Zacht & veilig (0-3)","Speels & sterk (4-12)","Eigen stijl (13-17)","Tijdloze elegantie (18-50)","Comfort & verfijning (50-70)","Luxe voor thuis"],
    shopCats:{baby:{tag:"AURA LUXE &middot; Baby & Peuter",h1:"Baby & Peuter",sub:"0&ndash;3 jaar &mdash; zacht, veilig en liefdevol verzorgd",badge:"Collectie in opbouw",intro:"De allerkleinsten verdienen het zachtste. Onze selectie voor baby en peuter focust op huidvriendelijke stoffen, geurvrije verzorging en speelgoed dat veilig is om te ontdekken. Geselecteerd op wat een baby echt nodig heeft &mdash; geen overbodige toevoegingen, wel eerlijke kwaliteit.",segTitle:"Wat u vindt voor Baby & Peuter",segSub:"Drie pijlers, telkens zorgvuldig gekozen",segs:[["baby","Kleding & Stoffen","Zachte, ademende stoffen die de gevoelige babyhuid respecteren.","Zacht katoenen rompertje"],["rituals","Verzorging & Bad","Zachte wasgel en lotion, vrij van parfum en irriterende stoffen.","Kalmerende babylotion"],["home","Kamer & Rust","Slaaprituelen en kleine accenten voor een rustige kinderkamer.","Zachte slaapmuziek-box"]],products:[["baby","Zacht katoenen rompertje"],["rituals","Kalmerende babylotion"],["home","Zachte slaapmuziek-box"],["baby","Puntegarenbroekje"],["rituals","Geurvrije wasgel"]],whyTitle:"Waarom AURA LUXE voor Baby & Peuter",why:[["&#10022;","Huidvriendelijk","Alleen stoffen en formules die de gevoelige babyhuid respecteren."],["&#128230;","Eerlijke informatie","Ingredi&euml;nten en materialen helder beschreven &mdash; geen vage claims."],["&#9989;","Transparante levertijd","Levering altijd zichtbaar v&oacute;&oacute;r het afrekenen."],["&#128274;","Veilig & vertrouwd","U koopt rechtstreeks bij de retailer; wij verwijzen u eerlijk door."]]},kids:{tag:"AURA LUXE &middot; Kids",h1:"Kids",sub:"4&ndash;12 jaar &mdash; speels, praktisch en gemaakt om te beleven",badge:"Collectie in opbouw",intro:"Kinderen spelen, ontdekken en maken het mee. Onze kids-selectie combineert speelse stijl met praktische kledij die een drukke dag overleeft, plus verzorging en accessoires die kinderen zelf graag dragen. Kwaliteit die meegaat, niet wegwerp-mode.",segTitle:"Wat u vindt voor Kids",segSub:"Van speelkleding tot zelfverzorging",segs:[["kids","Kleding & Speels","Comfortabele kledij met printjes en kleuren die kinderen blij maken.","Speels T-shirt met print"],["beauty","Verzorging & Hygiene","Zachte zeep, shampoo en zonnebescherming voor actieve dagen.","Kinderzonnecrème SPF50"],["fashion","Accessoires & Rugzakken","Rugzakken, petten en sieraden die een kinderlook afmaken.","Kleurrijke kinderrugzak"]],products:[["kids","Speels T-shirt met print"],["beauty","Kinderzonnecrème SPF50"],["fashion","Kleurrijke kinderrugzak"],["kids","Sportieve legging"],["beauty","Zachte kinderzeep"]],whyTitle:"Waarom AURA LUXE voor Kids",why:[["&#10022;","Speels & sterk","Kledij die een actieve dag overleeft, met aandacht voor comfort."],["&#128230;","Geen copy-paste","Eigen beschrijvingen, geen letterlijke leveranciersteksten."],["&#9989;","Transparante levertijd","Duidelijkheid over levering v&oacute;&oacute;r het afrekenen."],["&#128274;","Veilig & vertrouwd","U koopt rechtstreeks bij de retailer; wij verwijzen u eerlijk door."]]},teens:{tag:"AURA LUXE &middot; Tieners",h1:"Tieners",sub:"13&ndash;17 jaar &mdash; eigen stijl, zelfvertrouwen en expressie",badge:"Collectie in opbouw",intro:"Tieners weten wat ze willen. Onze selectie geeft hen de ruimte om hun eigen stijl te vinden &mdash; van streetwear en make-up tot geur en accessoires die opvallen zonder te overdrijven. Eerlijke merken, eerlijke prijzen, geen druk om mee te doen aan wegwerptrends.",segTitle:"Wat u vindt voor Tieners",segSub:"Stijl die bij hen past",segs:[["teens","Kleding & Streetwear","Oversized hoodies, jurken en basics die eigenzinnig zijn.","Oversized hoodie"],["makeup","Make-up & Expressie","Lippenstift, mascara en highlighter voor een eerste eigen look.","Precisie mascara"],["parfum","Geur & Identiteit","Frisse, jonge geuren die een signatuur worden.","Signature eau de parfum"]],products:[["teens","Oversized hoodie"],["makeup","Precisie mascara"],["parfum","Signature eau de parfum"],["teens","Tijdloze jeans"],["makeup","Voedende lippenbalsem met kleur"]],whyTitle:"Waarom AURA LUXE voor Tieners",why:[["&#10022;","Eigen stijl","Ruimte voor expressie, niet voor wegwerptrends."],["&#128230;","Eerlijke merken","Geselecteerd op kwaliteit en herkomst, niet op hype."],["&#9989;","Transparante levertijd","Levering zichtbaar v&oacute;&oacute;r het afrekenen."],["&#128274;","Veilig & vertrouwd","U koopt rechtstreeks bij de retailer; wij verwijzen u eerlijk door."]]},adults:{tag:"AURA LUXE &middot; Volwassenen",h1:"Volwassenen",sub:"18&ndash;50 jaar &mdash; tijdloze elegantie voor elke gelegenheid",badge:"Collectie in opbouw",intro:"Voor wie de dag vult met werk, gezin en eigen momenten. Onze volwassenen-selectie brengt verfijning in skincare, parfum, make-up, kleding en accessoires &mdash; stukken die jarenlang meegaan en telkens weer kloppen. Van de eerste vergadering tot het weekend weg.",segTitle:"Wat u vindt voor Volwassenen",segSub:"De volledige AURA LUXE-edit",segs:[["skincare","Skincare & Verzorging","Gezichts- en lichaamsverzorging die werkt en rust brengt.","Hydraterende dagcrème"],["parfum","Parfum & Signatuur","Geuren met karakter, van tijdloos tot niche.","Signature eau de parfum 50ml"],["accessoires","Kleding & Accessoires","Tijdloze basics, statement-stukken en fijne sieraden.","Fijne gouden ketting"]],products:[["skincare","Hydraterende dagcrème"],["parfum","Signature eau de parfum 50ml"],["accessoires","Fijne gouden ketting"],["makeup","Langhoudende foundation"],["kleding","Tijdloze wollen jas"]],whyTitle:"Waarom AURA LUXE voor Volwassenen",why:[["&#10022;","Kwaliteit die blijft","Stukken die jaren meegaan, niet één seizoen."],["&#128230;","Eigen beeldmateriaal","Elke foto in eigen huisstijl, nooit leveranciersbeelden."],["&#9989;","Transparante levertijd","Levering zichtbaar vóór het afrekenen."],["&#128274;","Veilig & vertrouwd","U koopt rechtstreeks bij de retailer; wij verwijzen u eerlijk door."]]},seniors:{tag:"AURA LUXE &middot; Senioren",h1:"Senioren",sub:"50&ndash;70 jaar &mdash; comfortabele elegantie met aandacht voor draagplezier",badge:"Collectie in opbouw",intro:"Luxe op rijpere leeftijd draait om comfort én stijl. Onze senioren-selectie verenigt zachte stoffen, verzorging die de rijpere huid voedt, en kleding met een aangepaste pasvorm &mdash; elegant zonder in te boeten op gemak. Want verfijning hoeft niet oncomfortabel te zijn.",segTitle:"Wat u vindt voor Senioren",segSub:"Comfort en verfijning, samen",segs:[["seniors","Kleding & Pasvorm","Linnen blouses, zachte truien en jassen met aandacht voor draagcomfort.","Comfortabele linnen blouse"],["skincare","Verzorging 50+","Rijke crèmes en serums die de rijpere huid voeden.","Voedende nachtcrème"],["home","Wellness & Rust","Badrituelen en geurkaarsen voor ontspanning thuis.","Signatuur geurkaars"]],products:[["seniors","Comfortabele linnen blouse"],["skincare","Voedende nachtcrème"],["home","Signatuur geurkaars"],["seniors","Zachte gebreide trui"],["skincare","Kalmerend gezichtsserum"]],whyTitle:"Waarom AURA LUXE voor Senioren",why:[["&#10022;","Comfort eerst","Pasvorm en stof gekozen voor draagplezier, niet voor trend."],["&#128230;","Eerlijke informatie","Werking en materialen helder beschreven."],["&#9989;","Transparante levertijd","Levering zichtbaar vóór het afrekenen."],["&#128274;","Veilig & vertrouwd","U koopt rechtstreeks bij de retailer; wij verwijzen u eerlijk door."]]},home:{tag:"AURA LUXE &middot; Home & Wellness",h1:"Home & Wellness",sub:"Luxe die thuis blijft &mdash; voor het hele gezin",badge:"Collectie in opbouw",intro:"Welzijn stopt niet bij de badkamerspiegel. Onze Home & Wellness-selectie brengt dezelfde verfijning naar de rest van het huis &mdash; geurkaarsen, bad- en douche-essentials en kleine rituelen die een gewone avond net iets bijzonderder maken. Geselecteerd op kwaliteit, geur en afwerking, voor jong en oud.",segTitle:"Wat u vindt in Home & Wellness",segSub:"Rust en verfijning voor in huis",segs:[["home","Geurkaarsen & Diffusers","Signatuurgeuren voor in huis, langdurig en subtiel.","Signatuur geurkaars"],["rituals","Bad & Douche Rituelen","Verzorgende essentials voor een moment van ontspanning.","Verzorgende douchegel"],["beauty","Kleine Luxe-accenten","Details die een interieur net dat tikkeltje verfijnder maken.","Decoratief luxe-accessoire"]],products:[["home","Signatuur geurkaars"],["rituals","Verzorgende douchegel"],["beauty","Decoratief luxe-accessoire"],["home","Aromatische diffuser-olie"],["rituals","Zachte badhanddoekenset"]],whyTitle:"Waarom AURA LUXE Home & Wellness",why:[["&#10022;","Geselecteerd op geur & afwerking","Alleen producten die echt een verschil maken thuis."],["&#128230;","Geen copy-paste","Eigen beschrijvingen, geen letterlijke leveranciersteksten."],["&#9989;","Transparante levertijd","Levering duidelijk zichtbaar voor het afrekenen."],["&#128274;","Veilig & vertrouwd","U koopt rechtstreeks bij de retailer; wij verwijzen u eerlijk door."]]}},
    ...
    ai: { hero: "Geen enkele vastgoedlead blijft nog liggen", heroSub: "AI-automatisering voor makelaars in BE en NL — leads kwalificeren, opvolgen en onboarden, dag en nacht, zonder extra personeel.", cta: "Plan een kennismakingsgesprek", dienstenTitle: "Onze diensten", diensten: [["🎯", "Lead-kwalificatie", "Automatische score van binnenkomende leads (website, Immoweb, Zimmo, social) en warme leads meteen doorgestuurd naar de juiste makelaar."], ["💬", "Follow-up op automatische piloot", "Gepersonaliseerde opvolgberichten via e-mail en WhatsApp tot een lead reageert of een bezoek boekt — geen lead wordt nog koud."], ["📅", "Slimme bezoekplanning", "Kandidaat-kopers en -huurders boeken zelf een bezichtiging, synchroon met de agenda van de makelaar."], ["🗂️", "Klantonboarding", "Nieuwe klanten en dossiers automatisch klaargezet in het CRM, documenten verzameld, welkomstmail verstuurd."], ["📊", "Maandelijkse rapportage", "Overzicht van leadvolume, conversie per bron en tijd-tot-eerste-reactie."]], aanpakTitle: "Zo werkt het", steps: ["Kennismaking — korte intake van het kantoor: bronnen, CRM, huidige werkwijze.", "Opzet — workflows op maat gebouwd met no-code automatisering (n8n/Make), gekoppeld aan bestaande tools.", "Testperiode — 2 weken proefdraaien op een deel van de leads, resultaten samen bekeken.", "Livegang & maandelijkse retainer — volledige uitrol, doorlopende opvolging en optimalisatie."], email: "sales@bierinckx.com", prijsNote: "Opstartkost eenmalig plus een maandelijkse retainer, steeds op maat via een vrijblijvend gesprek — geen vaste pakketprijzen zolang het aanbod nog in opstartfase zit." }
  },
  fr: {
    ...
    hero:{tag:"Conseil luxe indépendant · BE / NL / FR / DE",h1b:"Luxe pour",h1c:"toute la famille",sub:"Du bébé au senior : AURA LUXE sélectionne avec soin vêtements, soins, parfums et accessoires chez les meilleurs détaillants comme Douglas, Zalando, Rituals et Lookfantastic — pour que chaque membre de la famille fasse le meilleur choix au meilleur prix.",cta1:"Voir la collection",cta2:"Notre méthode"},
    cats:["Bébé & Bambin","Enfants","Adolescents","Adultes","Seniors","Maison & Bien-être"],
    catDesc:["Doux & sûr (0-3)","Ludique & solide (4-12)","Propre style (13-17)","Élégance intemporelle (18-50)","Confort & raffinement (50-70)","Luxe à la maison"],
    shopCats:{baby:{tag:"AURA LUXE &middot; Bébé & Bambin",h1:"Bébé & Bambin",sub:"0&ndash;3 ans &mdash; doux, sûr et tendrement soigné",badge:"Collection en cours",intro:"Les plus petits méritent le plus doux. Notre sélection pour bébé et bambin mise sur des tissus respectueux de la peau, des soins sans parfum et des jouets sûrs à explorer. Choisis pour ce dont un bébé a vraiment besoin &mdash; sans ajouts superflus, avec une qualité honnête.",segTitle:"Ce que vous trouverez pour Bébé & Bambin",segSub:"Trois piliers, toujours choisis avec soin",segs:[["baby","Vêtements & Tissus","Tissus doux et respirants qui respectent la peau sensible du bébé.","Body en coton doux"],["rituals","Soins & Bain","Gel et lotion doux, sans parfum ni substances irritantes.","Lotion apaisante bébé"],["home","Chambre & Calme","Rituels du sommeil et petits accents pour une chambre sereine.","Boîte à musique douce"]],products:[["baby","Body en coton doux"],["rituals","Lotion apaisante bébé"],["home","Boîte à musique douce"],["baby","Petit body en maille"],["rituals","Gel sans parfum"]],whyTitle:"Pourquoi AURA LUXE pour Bébé & Bambin",why:[["&#10022;","Respecte la peau","Seuls tissus et formules respectant la peau sensible du bébé."],["&#128230;","Infos honnêtes","Ingrédients et matériaux clairement décrits &mdash; pas d'allégations vagues."],["&#9989;","Délai transparent","Livraison toujours visible avant le paiement."],["&#128274;","Sûr & fiable","Vous achetez directement au détaillant ; nous orientons honnêtement."]]},kids:{tag:"AURA LUXE &middot; Enfants",h1:"Enfants",sub:"4&ndash;12 ans &mdash; ludique, pratique et fait pour vivre",badge:"Collection en cours",intro:"Les enfants jouent, découvrent et expérimentent. Notre sélection kids combine style ludique et vêtements pratiques qui survivent à une journée chargée, plus des soins et accessoires que les enfants aiment porter. Une qualité qui dure, pas de mode jetable.",segTitle:"Ce que vous trouverez pour les Enfants",segSub:"Du vêtement de jeu à l'autonomie",segs:[["kids","Vêtements & Ludique","Vêtements confortables aux imprimés et couleurs qui font plaisir.","T-shirt imprimé ludique"],["beauty","Soins & Hygiène","Savon doux, shampooing et protection solaire pour les journées actives.","Crème solaire enfant SPF50"],["fashion","Accessoires & Cartables","Cartables, casquettes et bijoux qui complètent un look enfant.","Cartable coloré"]],products:[["kids","T-shirt imprimé ludique"],["beauty","Crème solaire enfant SPF50"],["fashion","Cartable coloré"],["kids","Legging de sport"],["beauty","Savon doux enfant"]],whyTitle:"Pourquoi AURA LUXE pour les Enfants",why:[["&#10022;","Ludique & solide","Vêtements qui survivent à une journée active, dans le confort."],["&#128230;","Pas de copier-coller","Descriptions propres, jamais de textes fournisseur."],["&#9989;","Délai transparent","Livraison visible avant le paiement."],["&#128274;","Sûr & fiable","Vous achetez directement au détaillant ; nous orientons honnêtement."]]},teens:{tag:"AURA LUXE &middot; Adolescents",h1:"Adolescents",sub:"13&ndash;17 ans &mdash; propre style, confiance et expression",badge:"Collection en cours",intro:"Les adolescents savent ce qu'ils veulent. Notre sélection leur laisse l'espace pour trouver leur style &mdash; du streetwear et maquillage aux parfums et accessoires qui se remarquent sans excès. Marques honnêtes, prix honnêtes, pas de pression pour suivre les tendances jetables.",segTitle:"Ce que vous trouverez pour les Adolescents",segSub:"Un style qui leur ressemble",segs:[["teens","Vêtements & Streetwear","Hoodies oversize, robes et basics au caractère affirmé.","Hoodie oversize"],["makeup","Maquillage & Expression","Rouge à lèvres, mascara et highlighter pour un premier look.","Mascara de précision"],["parfum","Parfum & Identité","Parfums frais et jeunes qui deviennent une signature.","Eau de parfum signature"]],products:[["teens","Hoodie oversize"],["makeup","Mascara de précision"],["parfum","Eau de parfum signature"],["teens","Jean intemporel"],["makeup","Baume à lèvres teinté nourrissant"]],whyTitle:"Pourquoi AURA LUXE pour les Adolescents",why:[["&#10022;","Propre style","Espace pour l'expression, pas pour les tendances jetables."],["&#128230;","Marques honnêtes","Choisies pour qualité et origine, pas pour le buzz."],["&#9989;","Délai transparent","Livraison visible avant le paiement."],["&#128274;","Sûr & fiable","Vous achetez directement au détaillant ; nous orientons honnêtement."]]},adults:{tag:"AURA LUXE &middot; Adultes",h1:"Adultes",sub:"18&ndash;50 ans &mdash; élégance intemporelle pour chaque occasion",badge:"Collection en cours",intro:"Pour qui remplit ses journées de travail, famille et moments personnels. Notre sélection adultes apporte raffinement en soins, parfum, maquillage, vêtements et accessoires &mdash; des pièces qui durent des années et sont toujours justes. De la première réunion au week-end escapade.",segTitle:"Ce que vous trouverez pour les Adultes",segSub:"Toute l'édition AURA LUXE",segs:[["skincare","Soins & Skincare","Soins du visage et du corps qui agissent et apaisent.","Crème de jour hydratante"],["parfum","Parfum & Signature","Parfums au caractère, du intemporel au niche.","Eau de parfum signature 50ml"],["accessoires","Vêtements & Accessoires","Basiques intemporels, pièces fortes et beaux bijoux.","Collier fin en or"]],products:[["skincare","Crème de jour hydratante"],["parfum","Eau de parfum signature 50ml"],["accessoires","Collier fin en or"],["makeup","Fond de teint longue tenue"],["kleding","Manteau en laine intemporel"]],whyTitle:"Pourquoi AURA LUXE pour les Adultes",why:[["&#10022;","Qualité qui dure","Des pièces qui tiennent des années, pas une saison."],["&#128230;","Visuels propres","Chaque photo dans notre charte, jamais d'images fournisseur."],["&#9989;","Délai transparent","Livraison visible avant le paiement."],["&#128274;","Sûr & fiable","Vous achetez directement au détaillant ; nous orientons honnêtement."]]},seniors:{tag:"AURA LUXE &middot; Seniors",h1:"Seniors",sub:"50&ndash;70 ans &mdash; élégance confortable avec attention au plaisir de porter",badge:"Collection en cours",intro:"Le luxe à un âge mûr, c'est le confort et le style. Notre sélection seniors réunit tissus doux, soins qui nourrissent la peau mûre et vêtements à coupe adaptée &mdash; élégant sans sacrifier l'aisance. Car le raffinement n'a pas à être inconfortable.",segTitle:"Ce que vous trouverez pour les Seniors",segSub:"Confort et raffinement, ensemble",segs:[["seniors","Vêtements & Coupe","Blouses en lin, pulls doux et manteaux pensés pour le confort.","Blouse en lin confortable"],["skincare","Soins 50+","Crèmes et sérums riches qui nourrissent la peau mûre.","Crème de nuit nourrissante"],["home","Bien-être & Calme","Rituels de bain et bougies parfumées pour la détente.","Bougie parfumée signature"]],products:[["seniors","Blouse en lin confortable"],["skincare","Crème de nuit nourrissante"],["home","Bougie parfumée signature"],["seniors","Pull tricoté doux"],["skincare","Sérum apaisant visage"]],whyTitle:"Pourquoi AURA LUXE pour les Seniors",why:[["&#10022;","Confort d'abord","Coupe et tissu choisis pour le plaisir de porter, pas la tendance."],["&#128230;","Infos honnêtes","Action et matériaux clairement décrits."],["&#9989;","Délai transparent","Livraison visible avant le paiement."],["&#128274;","Sûr & fiable","Vous achetez directement au détaillant ; nous orientons honnêtement."]]},home:{tag:"AURA LUXE &middot; Maison & Bien-être",h1:"Maison & Bien-être",sub:"Le luxe qui reste à la maison &mdash; pour toute la famille",badge:"Collection en cours",intro:"Le bien-être ne s'arrête pas au miroir de la salle de bain. Notre sélection Maison & Bien-être apporte le même raffinement au reste de la maison &mdash; bougies parfumées, essentiels de bain et petits rituels qui rendent une soirée ordinaire un peu plus spéciale. Choisie pour qualité, parfum et finition, pour petits et grands.",segTitle:"Ce que vous trouverez dans Maison & Bien-être",segSub:"Calme et raffinement pour la maison",segs:[["home","Bougies & Diffuseurs","Parfums signature pour la maison, durables et subtils.","Bougie parfumée signature"],["rituals","Rituels de Bain & Douche","Essentiels nourrissants pour un moment de détente.","Gel douche nourrissant"],["beauty","Petits Accents de Luxe","Détails qui rendent un intérieur un peu plus raffiné.","Accessoire déco luxe"]],products:[["home","Bougie parfumée signature"],["rituals","Gel douche nourrissant"],["beauty","Accessoire déco luxe"],["home","Huile aromatique pour diffuseur"],["rituals","Set de serviettes de bain douces"]],whyTitle:"Pourquoi AURA LUXE Maison & Bien-être",why:[["&#10022;","Choisi pour parfum & finition","Seuls produits qui changent vraiment l'expérience à la maison."],["&#128230;","Pas de copier-coller","Descriptions propres, jamais de textes fournisseur."],["&#9989;","Délai transparent","Livraison clairement visible avant le paiement."],["&#128274;","Sûr & fiable","Vous achetez directement au détaillant ; nous orientons honnêtement."]]}},
    ...
    ai: { hero: "Aucun lead immobilier ne reste plus sans suite", heroSub: "Automatisation IA pour agences immobilières en BE et NL — qualification, suivi et onboarding des leads, jour et nuit, sans personnel supplémentaire.", cta: "Planifier un entretien de découverte", dienstenTitle: "Nos services", diensten: [["🎯", "Qualification des leads", "Score automatique des leads entrants (site, Immoweb, Zimmo, réseaux sociaux) et transfert immédiat des leads chauds au bon agent."], ["💬", "Suivi en pilote automatique", "Messages de suivi personnalisés par e-mail et WhatsApp jusqu'à réponse ou rendez-vous — plus aucun lead ne refroidit."], ["📅", "Planification intelligente des visites", "Les candidats acheteurs et locataires réservent eux-mêmes une visite, synchronisée avec l'agenda de l'agent."], ["🗂️", "Onboarding client", "Nouveaux clients et dossiers automatiquement préparés dans le CRM, documents rassemblés, e-mail de bienvenue envoyé."], ["📊", "Rapport mensuel", "Aperçu du volume de leads, conversion par source et délai de première réponse."]], aanpakTitle: "Comment ça marche", steps: ["Prise de contact — brève découverte de l'agence: sources, CRM, méthode actuelle.", "Mise en place — workflows sur mesure avec automatisation no-code (n8n/Make), connectés à vos outils.", "Période de test — 2 semaines d'essai sur une partie des leads, résultats évalués ensemble.", "Lancement & retainer mensuel — déploiement complet, suivi et optimisation continus."], email: "sales@bierinckx.com", prijsNote: "Frais de mise en place plus retainer mensuel, toujours sur mesure via un entretien sans engagement — pas de tarifs fixes tant que l'offre est en phase de lancement." }
  },
  en: {
    ...
    hero:{tag:"Independent luxury advice · BE / NL / FR / DE",h1b:"Luxury for",h1c:"the whole family",sub:"From baby to senior: AURA LUXE carefully selects clothing, skincare, fragrance and accessories from top retailers like Douglas, Zalando, Rituals and Lookfantastic — so every family member makes the best choice at the best price.",cta1:"View the collection",cta2:"How we work"},
    cats:["Baby & Toddler","Kids","Teens","Adults","Seniors","Home & Wellness"],
    catDesc:["Soft & safe (0-3)","Playful & tough (4-12)","Own style (13-17)","Timeless elegance (18-50)","Comfort & refinement (50-70)","Luxury at home"],
    shopCats:{baby:{tag:"AURA LUXE &middot; Baby & Toddler",h1:"Baby & Toddler",sub:"0&ndash;3 years &mdash; soft, safe and lovingly cared for",badge:"Collection coming soon",intro:"The very youngest deserve the softest. Our baby and toddler selection focuses on skin-friendly fabrics, fragrance-free care and toys that are safe to explore. Chosen for what a baby truly needs &mdash; no superfluous additions, just honest quality.",segTitle:"What you'll find for Baby & Toddler",segSub:"Three pillars, each chosen with care",segs:[["baby","Clothing & Fabrics","Soft, breathable fabrics that respect sensitive baby skin.","Soft cotton onesie"],["rituals","Care & Bath","Gentle wash and lotion, free from fragrance and irritants.","Calming baby lotion"],["home","Room & Calm","Sleep rituals and small accents for a peaceful nursery.","Soft music box"]],products:[["baby","Soft cotton onesie"],["rituals","Calming baby lotion"],["home","Soft music box"],["baby","Knitted baby trousers"],["rituals","Fragrance-free wash"]],whyTitle:"Why AURA LUXE for Baby & Toddler",why:[["&#10022;","Skin-friendly","Only fabrics and formulas that respect sensitive baby skin."],["&#128230;","Honest info","Ingredients and materials clearly described &mdash; no vague claims."],["&#9989;","Transparent delivery","Delivery always visible before checkout."],["&#128274;","Safe & trusted","You buy directly from the retailer; we point you honestly."]]},kids:{tag:"AURA LUXE &middot; Kids",h1:"Kids",sub:"4&ndash;12 years &mdash; playful, practical and made to be lived",badge:"Collection coming soon",intro:"Children play, discover and experience it all. Our kids selection mixes playful style with practical clothing that survives a busy day, plus care and accessories kids love to wear. Quality that lasts, not disposable fashion.",segTitle:"What you'll find for Kids",segSub:"From play clothes to self-care",segs:[["kids","Clothing & Playful","Comfortable clothing with prints and colours kids love.","Playful printed t-shirt"],["beauty","Care & Hygiene","Gentle soap, shampoo and sun protection for active days.","Kids sunscreen SPF50"],["fashion","Accessories & Backpacks","Backpacks, caps and jewellery that finish a kids look.","Colourful kids backpack"]],products:[["kids","Playful printed t-shirt"],["beauty","Kids sunscreen SPF50"],["fashion","Colourful kids backpack"],["kids","Sporty leggings"],["beauty","Gentle kids soap"]],whyTitle:"Why AURA LUXE for Kids",why:[["&#10022;","Playful & tough","Clothing that survives an active day, with comfort in mind."],["&#128230;","No copy-paste","Original descriptions, never supplier text."],["&#9989;","Transparent delivery","Delivery visible before checkout."],["&#128274;","Safe & trusted","You buy directly from the retailer; we point you honestly."]]},teens:{tag:"AURA LUXE &middot; Teens",h1:"Teens",sub:"13&ndash;17 years &mdash; own style, confidence and expression",badge:"Collection coming soon",intro:"Teens know what they want. Our selection gives them room to find their own style &mdash; from streetwear and make-up to scent and accessories that stand out without overdoing it. Honest brands, honest prices, no pressure to follow disposable trends.",segTitle:"What you'll find for Teens",segSub:"Style that fits them",segs:[["teens","Clothing & Streetwear","Oversized hoodies, dresses and basics with character.","Oversized hoodie"],["makeup","Make-up & Expression","Lipstick, mascara and highlighter for a first own look.","Precision mascara"],["parfum","Scent & Identity","Fresh, young fragrances that become a signature.","Signature eau de parfum"]],products:[["teens","Oversized hoodie"],["makeup","Precision mascara"],["parfum","Signature eau de parfum"],["teens","Timeless jeans"],["makeup","Tinted nourishing lip balm"]],whyTitle:"Why AURA LUXE for Teens",why:[["&#10022;","Own style","Room for expression, not for disposable trends."],["&#128230;","Honest brands","Chosen for quality and origin, not hype."],["&#9989;","Transparent delivery","Delivery visible before checkout."],["&#128274;","Safe & trusted","You buy directly from the retailer; we point you honestly."]]},adults:{tag:"AURA LUXE &middot; Adults",h1:"Adults",sub:"18&ndash;50 years &mdash; timeless elegance for every occasion",badge:"Collection coming soon",intro:"For those who fill their day with work, family and own moments. Our adults selection brings refinement to skincare, fragrance, make-up, clothing and accessories &mdash; pieces that last for years and always click. From the first meeting to the weekend away.",segTitle:"What you'll find for Adults",segSub:"The full AURA LUXE edit",segs:[["skincare","Skincare & Care","Face and body care that works and brings calm.","Hydrating day cream"],["parfum","Fragrance & Signature","Scents with character, from timeless to niche.","Signature eau de parfum 50ml"],["accessoires","Clothing & Accessories","Timeless basics, statement pieces and fine jewellery.","Fine gold necklace"]],products:[["skincare","Hydrating day cream"],["parfum","Signature eau de parfum 50ml"],["accessoires","Fine gold necklace"],["makeup","Long-wear foundation"],["kleding","Timeless wool coat"]],whyTitle:"Why AURA LUXE for Adults",why:[["&#10022;","Quality that lasts","Pieces that last years, not one season."],["&#128230;","Original imagery","Every photo in our own style, never supplier images."],["&#9989;","Transparent delivery","Delivery visible before checkout."],["&#128274;","Safe & trusted","You buy directly from the retailer; we point you honestly."]]},seniors:{tag:"AURA LUXE &middot; Seniors",h1:"Seniors",sub:"50&ndash;70 years &mdash; comfortable elegance with attention to wearability",badge:"Collection coming soon",intro:"Luxury at a mature age is about comfort and style. Our seniors selection unites soft fabrics, care that nourishes mature skin, and clothing with an adapted fit &mdash; elegant without sacrificing ease. Because refinement need not be uncomfortable.",segTitle:"What you'll find for Seniors",segSub:"Comfort and refinement, together",segs:[["seniors","Clothing & Fit","Linen blouses, soft knits and coats with wearability in mind.","Comfortable linen blouse"],["skincare","Care 50+","Rich creams and serums that nourish mature skin.","Nourishing night cream"],["home","Wellness & Calm","Bath rituals and scented candles for relaxation at home.","Signature scented candle"]],products:[["seniors","Comfortable linen blouse"],["skincare","Nourishing night cream"],["home","Signature scented candle"],["seniors","Soft knitted jumper"],["skincare","Calming face serum"]],whyTitle:"Why AURA LUXE for Seniors",why:[["&#10022;","Comfort first","Fit and fabric chosen for wearability, not trend."],["&#128230;","Honest info","Action and materials clearly described."],["&#9989;","Transparent delivery","Delivery visible before checkout."],["&#128274;","Safe & trusted","You buy directly from the retailer; we point you honestly."]]},home:{tag:"AURA LUXE &middot; Home & Wellness",h1:"Home & Wellness",sub:"Luxury that stays home &mdash; for the whole family",badge:"Collection coming soon",intro:"Wellbeing doesn't stop at the bathroom mirror. Our Home & Wellness selection brings the same refinement to the rest of the house &mdash; scented candles, bath and shower essentials and small rituals that make an ordinary evening a little more special. Selected for quality, scent and finish, for young and old.",segTitle:"What you'll find in Home & Wellness",segSub:"Calm and refinement for the home",segs:[["home","Candles & Diffusers","Signature home scents, long-lasting and subtle.","Signature scented candle"],["rituals","Bath & Shower Rituals","Nurturing essentials for a moment of relaxation.","Nourishing shower gel"],["beauty","Small Luxury Accents","Details that make an interior that little bit more refined.","Decorative luxury accent"]],products:[["home","Signature scented candle"],["rituals","Nourishing shower gel"],["beauty","Decorative luxury accent"],["home","Aromatic diffuser oil"],["rituals","Soft bath towel set"]],whyTitle:"Why AURA LUXE Home & Wellness",why:[["&#10022;","Selected for scent & finish","Only products that genuinely change the experience at home."],["&#128230;","No copy-paste","Original descriptions, never supplier text copied verbatim."],["&#9989;","Transparent delivery","Delivery clearly shown before checkout."],["&#128274;","Safe & trusted","You buy directly and securely from the retailer itself; we simply point you there, honestly."]]}},
    ...
    ai: { hero: "No real estate lead falls through the cracks anymore", heroSub: "AI automation for real estate agencies in BE and NL — qualifying, following up and onboarding leads, day and night, without extra staff.", cta: "Book an introductory call", dienstenTitle: "What we do", diensten: [["🎯", "Lead qualification", "Automatically scores incoming leads (website, Immoweb, Zimmo, social) and routes hot leads to the right agent instantly."], ["💬", "Follow-up on autopilot", "Personalised follow-up messages via email and WhatsApp until a lead replies or books a viewing — no lead ever goes cold."], ["📅", "Smart viewing scheduling", "Prospective buyers and renters book their own viewing, synced with the agent's calendar."], ["🗂️", "Client onboarding", "New clients and files automatically set up in the CRM, documents collected, welcome email sent."], ["📊", "Monthly reporting", "Overview of lead volume, conversion per source and time-to-first-response."]], aanpakTitle: "How it works", steps: ["Intake — a short introduction to the agency: sources, CRM, current way of working.", "Setup — workflows built to measure using no-code automation (n8n/Make), connected to existing tools.", "Test period — 2 weeks running on a portion of leads, results reviewed together.", "Go-live & monthly retainer — full rollout, ongoing follow-up and optimisation."], email: "sales@bierinckx.com", prijsNote: "One-off setup fee plus a monthly retainer, always tailored via a no-obligation call — no fixed package pricing while the offer is still in launch phase." }
  },
  de: {
    ...
    hero:{tag:"Unabhängige Luxus-Beratung · BE / NL / FR / DE",h1b:"Luxus für",h1c:"die ganze Familie",sub:"Vom Baby bis zum Senior: AURA LUXE wählt sorgfältig Kleidung, Pflege, Duft und Accessoires von Top-Händlern wie Douglas, Zalando, Rituals und Lookfantastic aus — damit jedes Familienmitglied die beste Wahl zum besten Preis trifft.",cta1:"Kollektion ansehen",cta2:"Unsere Methode"},
    cats:["Baby & Kleinkind","Kids","Teenager","Erwachsene","Senioren","Home & Wellness"],
    catDesc:["Weich & sicher (0-3)","Spielerisch & stark (4-12)","Eigener Stil (13-17)","Zeitlose Eleganz (18-50)","Komfort & Raffinesse (50-70)","Luxus zu Hause"],
    shopCats:{baby:{tag:"AURA LUXE &middot; Baby & Kleinkind",h1:"Baby & Kleinkind",sub:"0&ndash;3 Jahre &mdash; weich, sicher und liebevoll versorgt",badge:"Kollektion im Aufbau",intro:"Die Kleinsten verdienen das Weichste. Unsere Auswahl für Baby und Kleinkind setzt auf hautfreundliche Stoffe, duftfreie Pflege und Spielzeug, das sicher zu entdecken ist. Gewählt für das, was ein Baby wirklich braucht &mdash; keine überflüssigen Zusätze, dafür ehrliche Qualität.",segTitle:"Was Sie für Baby & Kleinkind finden",segSub:"Drei Säulen, stets sorgfältig gewählt",segs:[["baby","Kleidung & Stoffe","Weiche, atmungsaktive Stoffe, die die sensible Babyhaut respektieren.","Weicher Baumwoll-Strampler"],["rituals","Pflege & Bad","Sanfter Waschgel und Lotion, frei von Duft und Reizstoffen.","Beruhigende Babylotion"],["home","Zimmer & Ruhe","Schlafrituale und kleine Akzente für ein ruhiges Kinderzimmer.","Weiche Spieldose"]],products:[["baby","Weicher Baumwoll-Strampler"],["rituals","Beruhigende Babylotion"],["home","Weiche Spieldose"],["baby","Gestrickte Babyhose"],["rituals","Duftfreies Waschgel"]],whyTitle:"Warum AURA LUXE für Baby & Kleinkind",why:[["&#10022;","Hautfreundlich","Nur Stoffe und Formeln, die die sensible Babyhaut respektieren."],["&#128230;","Ehrliche Infos","Inhaltsstoffe und Materialien klar beschrieben &mdash; keine vagen Behauptungen."],["&#9989;","Transparente Lieferzeit","Lieferung immer sichtbar vor dem Bezahlen."],["&#128274;","Sicher & vertrauenswürdig","Sie kaufen direkt beim Händler; wir verweisen ehrlich."]]},kids:{tag:"AURA LUXE &middot; Kids",h1:"Kids",sub:"4&ndash;12 Jahre &mdash; verspielt, praktisch und zum Erleben gemacht",badge:"Kollektion im Aufbau",intro:"Kinder spielen, entdecken und erleben alles. Unsere Kids-Auswahl mischt verspielten Stil mit praktischer Kleidung, die einen vollen Tag übersteht, plus Pflege und Accessoires, die Kinder gern tragen. Qualität, die hält, keine Wegwerfmode.",segTitle:"Was Sie für Kids finden",segSub:"Von Spielkleidung zur Selbstfürsorge",segs:[["kids","Kleidung & Verspielt","Bequeme Kleidung mit Prints und Farben, die Kinder freuen.","Verspieltes T-Shirt mit Print"],["beauty","Pflege & Hygiene","Sanfte Seife, Shampoo und Sonnenschutz für aktive Tage.","Kinder-Sonnenschutz SPF50"],["fashion","Accessoires & Rucksäcke","Rucksäcke, Caps und Schmuck, die einen Kinderlook abrunden.","Bunter Kinderrucksack"]],products:[["kids","Verspieltes T-Shirt mit Print"],["beauty","Kinder-Sonnenschutz SPF50"],["fashion","Bunter Kinderrucksack"],["kids","Sportliche Leggings"],["beauty","Sanfte Kinderseife"]],whyTitle:"Warum AURA LUXE für Kids",why:[["&#10022;","Verspielt & stark","Kleidung, die einen aktiven Tag übersteht, mit Blick auf Komfort."],["&#128230;","Kein Copy-Paste","Eigene Beschreibungen, keine Lieferantentexte."],["&#9989;","Transparente Lieferzeit","Lieferung sichtbar vor dem Bezahlen."],["&#128274;","Sicher & vertrauenswürdig","Sie kaufen direkt beim Händler; wir verweisen ehrlich."]]},teens:{tag:"AURA LUXE &middot; Teenager",h1:"Teenager",sub:"13&ndash;17 Jahre &mdash; eigener Stil, Selbstvertrauen und Ausdruck",badge:"Kollektion im Aufbau",intro:"Teenager wissen, was sie wollen. Unsere Auswahl gibt ihnen Raum, ihren eigenen Stil zu finden &mdash; von Streetwear und Make-up bis Duft und Accessoires, die auffallen, ohne zu übertreiben. Ehrliche Marken, ehrliche Preise, kein Druck, Wegwerftrends zu folgen.",segTitle:"Was Sie für Teenager finden",segSub:"Stil, der zu ihnen passt",segs:[["teens","Kleidung & Streetwear","Oversize-Hoodies, Kleider und Basics mit Charakter.","Oversize-Hoodie"],["makeup","Make-up & Ausdruck","Lippenstift, Mascara und Highlighter für den ersten eigenen Look.","Präzisions-Mascara"],["parfum","Duft & Identität","Frische, junge Düfte, die zur Signatur werden.","Signature Eau de Parfum"]],products:[["teens","Oversize-Hoodie"],["makeup","Präzisions-Mascara"],["parfum","Signature Eau de Parfum"],["teens","Zeitlose Jeans"],["makeup","Pflegender Lippenbalsam mit Farbe"]],whyTitle:"Warum AURA LUXE für Teenager",why:[["&#10022;","Eigener Stil","Raum für Ausdruck, nicht für Wegwerftrends."],["&#128230;","Ehrliche Marken","Gewählt für Qualität und Herkunft, nicht für Hype."],["&#9989;","Transparente Lieferzeit","Lieferung sichtbar vor dem Bezahlen."],["&#128274;","Sicher & vertrauenswürdig","Sie kaufen direkt beim Händler; wir verweisen ehrlich."]]},adults:{tag:"AURA LUXE &middot; Erwachsene",h1:"Erwachsene",sub:"18&ndash;50 Jahre &mdash; zeitlose Eleganz für jeden Anlass",badge:"Kollektion im Aufbau",intro:"Für alle, die ihren Tag mit Arbeit, Familie und eigenen Momenten füllen. Unsere Erwachsenen-Auswahl bringt Raffinesse in Pflege, Duft, Make-up, Kleidung und Accessoires &mdash; Stücke, die Jahre halten und immer passen. Vom ersten Meeting bis zum Wochenendetrip.",segTitle:"Was Sie für Erwachsene finden",segSub:"Die ganze AURA LUXE-Edition",segs:[["skincare","Hautpflege & Care","Gesichts- und Körperpflege, die wirkt und Ruhe bringt.","Feuchtigkeitsspendende Tagescreme"],["parfum","Duft & Signatur","Düfte mit Charakter, vom Zeitlosen bis Nische.","Signature Eau de Parfum 50ml"],["accessoires","Kleidung & Accessoires","Zeitlose Basics, Statement-Stücke und feiner Schmuck.","Feine Goldkette"]],products:[["skincare","Feuchtigkeitsspendende Tagescreme"],["parfum","Signature Eau de Parfum 50ml"],["accessoires","Feine Goldkette"],["makeup","Langanhaltendes Foundation"],["kleding","Zeitloser Wollmantel"]],whyTitle:"Warum AURA LUXE für Erwachsene",why:[["&#10022;","Qualität, die hält","Stücke, die Jahre halten, nicht eine Saison."],["&#128230;","Eigenes Bildmaterial","Jedes Foto im eigenen Stil, nie Lieferantenbilder."],["&#9989;","Transparente Lieferzeit","Lieferung sichtbar vor dem Bezahlen."],["&#128274;","Sicher & vertrauenswürdig","Sie kaufen direkt beim Händler; wir verweisen ehrlich."]]},seniors:{tag:"AURA LUXE &middot; Senioren",h1:"Senioren",sub:"50&ndash;70 Jahre &mdash; komfortable Eleganz mit Blick auf Tragekomfort",badge:"Kollektion im Aufbau",intro:"Luxus im reiferen Alter bedeutet Komfort und Stil. Unsere Senioren-Auswahl vereint weiche Stoffe, Pflege, die reifere Haut nährt, und Kleidung mit angepasster Passform &mdash; elegant, ohne auf Bequemlichkeit zu verzichten. Denn Raffinesse muss nicht unbequem sein.",segTitle:"Was Sie für Senioren finden",segSub:"Komfort und Raffinesse, gemeinsam",segs:[["seniors","Kleidung & Passform","Leinenblusen, weiche Strickjacken und Mäntel mit Tragekomfort.","Bequeme Leinenbluse"],["skincare","Pflege 50+","Reiche Cremes und Seren, die reifere Haut nähren.","Nährende Nachtcreme"],["home","Wellness & Ruhe","Badrituale und Duftkerzen für Entspannung zu Hause.","Signatur-Duftkerze"]],products:[["seniors","Bequeme Leinenbluse"],["skincare","Nährende Nachtcreme"],["home","Signatur-Duftkerze"],["seniors","Weicher Strickpullover"],["skincare","Beruhigendes Gesichtsserum"]],whyTitle:"Warum AURA LUXE für Senioren",why:[["&#10022;","Komfort zuerst","Passform und Stoff für Tragekomfort gewählt, nicht für Trend."],["&#128230;","Ehrliche Infos","Wirkung und Materialien klar beschrieben."],["&#9989;","Transparente Lieferzeit","Lieferung sichtbar vor dem Bezahlen."],["&#128274;","Sicher & vertrauenswürdig","Sie kaufen direkt beim Händler; wir verweisen ehrlich."]]},home:{tag:"AURA LUXE &middot; Home & Wellness",h1:"Home & Wellness",sub:"Luxus, das zu Hause bleibt &mdash; für die ganze Familie",badge:"Kollektion im Aufbau",intro:"Wohlbefinden endet nicht am Badezimmerspiegel. Unsere Home & Wellness-Auswahl bringt dieselbe Raffinesse in den Rest des Hauses &mdash; Duftkerzen, Bad- und Dusch-Essentials und kleine Rituale, die einen gewöhnlichen Abend ein wenig besonderer machen. Ausgewählt nach Qualität, Duft und Verarbeitung, für jung und alt.",segTitle:"Was Sie in Home & Wellness finden",segSub:"Ruhe und Raffinesse fürs Zuhause",segs:[["home","Duftkerzen & Diffuser","Signaturdüfte fürs Zuhause, langanhaltend und subtil.","Signatur-Duftkerze"],["rituals","Bad & Dusch-Rituale","Pflegende Essentials für einen Moment der Entspannung.","Pflegendes Duschgel"],["beauty","Kleine Luxus-Akzente","Details, die ein Interieur noch etwas raffinierter machen.","Dekoratives Luxus-Accessoire"]],products:[["home","Signatur-Duftkerze"],["rituals","Pflegendes Duschgel"],["beauty","Dekoratives Luxus-Accessoire"],["home","Aromatisches Diffuser-Öl"],["rituals","Weiches Badehandtuch-Set"]],whyTitle:"Warum AURA LUXE Home & Wellness",why:[["&#10022;","Ausgewählt nach Duft & Verarbeitung","Nur Produkte, die zu Hause wirklich einen Unterschied machen."],["&#128230;","Kein Copy-Paste-Katalog","Eigene Beschreibungen, keine wortwörtlichen Lieferantentexte."],["&#9989;","Transparente Lieferzeit","Lieferung klar sichtbar vor dem Bezahlen."],["&#128274;","Sicher & vertrauenswürdig","Sie kaufen direkt und sicher beim Händler selbst; wir verweisen Sie lediglich ehrlich weiter."]]}},
    ...
    ai: { hero: "Kein Immobilien-Lead bleibt mehr liegen", heroSub: "KI-Automatisierung für Immobilienmakler in BE und NL — Leads qualifizieren, nachfassen und onboarden, Tag und Nacht, ohne zusätzliches Personal.", cta: "Kennenlerngespräch vereinbaren", dienstenTitle: "Unsere Leistungen", diensten: [["🎯", "Lead-Qualifizierung", "Automatische Bewertung eingehender Leads (Website, Immoweb, Zimmo, Social Media) und sofortige Weiterleitung heißer Leads an den richtigen Makler."], ["💬", "Follow-up im Autopilot", "Personalisierte Nachfass-Nachrichten per E-Mail und WhatsApp, bis ein Lead antwortet oder einen Termin bucht — kein Lead kühlt mehr ab."], ["📅", "Intelligente Besichtigungsplanung", "Interessenten buchen selbst einen Besichtigungstermin, synchron mit dem Kalender des Maklers."], ["🗂️", "Kunden-Onboarding", "Neue Kunden und Akten werden automatisch im CRM angelegt, Dokumente gesammelt, Willkommens-E-Mail versendet."], ["📊", "Monatliches Reporting", "Überblick über Lead-Volumen, Conversion pro Quelle und Zeit bis zur ersten Reaktion."]], aanpakTitle: "So funktioniert's", steps: ["Erstgespräch — kurzes Kennenlernen des Büros: Quellen, CRM, aktuelle Arbeitsweise.", "Aufbau — maßgeschneiderte Workflows mit No-Code-Automatisierung (n8n/Make), verbunden mit bestehenden Tools.", "Testphase — 2 Wochen Testlauf auf einem Teil der Leads, Ergebnisse gemeinsam ausgewertet.", "Livegang & monatliches Retainer — vollständiger Rollout, laufende Betreuung und Optimierung."], email: "sales@bierinckx.com", prijsNote: "Einmalige Einrichtungsgebühr plus monatliches Retainer, stets maßgeschneidert über ein unverbindliches Gespräch — keine festen Paketpreise, solange das Angebot sich in der Startphase befindet." }
  },
};
var PHOTOS = {
...
var CAT_SLUGS = {
  nl: ["baby-peuter", "kids", "tieners", "volwassenen", "senioren", "home-wellness"],
  fr: ["bebe-bambin", "enfants", "adolescents", "adultes", "seniors", "maison-bien-etre"],
  en: ["baby-toddler", "kids", "teens", "adults", "seniors", "home-wellness"],
  de: ["baby-kleinkind", "kids", "teenager", "erwachsene", "senioren", "home-wellness"]
};
...
<div class="nl" id="main-nl">
  ...
  <a onclick="go('${lang}','ai')" class="${cur === "ai" ? "ac" : ""}">` + t.nav.ai + `</a>
  <div class="ls">
...
function buildHome(t, lang) {
  ...
  const svcs = [
    ...
    ["✨", "AURA LUXE", lang === "nl" ? "Mid-to-high end luxe lifestyle voor het hele gezin — baby, kids, tieners, volwassenen, senioren, home & wellness." : lang === "fr" ? "Lifestyle de luxe haut de gamme pour toute la famille — bébé, enfants, adolescents, adultes, seniors, maison & bien-être." : lang === "de" ? "Mid-to-high-end Luxus-Lifestyle für die ganze Familie — Baby, Kids, Teenager, Erwachsene, Senioren, Home & Wellness." : "Mid-to-high end luxury lifestyle for the whole family — baby, kids, teens, adults, seniors, home & wellness.", "shop", lang === "nl" ? "Bekijk de collectie →" : lang === "fr" ? "Voir la collection →" : "Browse the collection →"]
...
` + foot(t, lang);
  const metaDesc = lang === "nl" ? `Mid-to-high end luxe lifestyle voor het hele gezin. Baby, kids, tieners, volwassenen, senioren, home & wellness. BE/NL/FR/DE.` : lang === "fr" ? `Lifestyle de luxe haut de gamme pour toute la famille. Bébé, enfants, adolescents, adultes, seniors, maison & bien-être. BE/NL/FR/DE.` : lang === "de" ? `Mid-to-high-end Luxus-Lifestyle für die ganze Familie. Baby, Kids, Teenager, Erwachsene, Senioren, Home & Wellness. BE/NL/FR/DE.` : `Mid-to-high end luxury lifestyle for the whole family. Baby, kids, teens, adults, seniors, home & wellness. BE/NL/FR/DE.`;
...
` + foot(t, lang);
  const shopMetaDesc = lang === "nl" ? `Mid-to-high end luxe lifestyle voor het hele gezin — baby (0-3), kids (4-12), tieners (13-17), volwassenen (18-50), senioren (50-70), home & wellness.` : lang === "fr" ? `Lifestyle de luxe haut de gamme pour toute la famille — bébé (0-3), enfants (4-12), adolescents (13-17), adultes (18-50), seniors (50-70), maison & bien-être.` : lang === "de" ? `Mid-to-high-end Luxus-Lifestyle für die ganze Familie — Baby (0-3), Kids (4-12), Teenager (13-17), Erwachsene (18-50), Senioren (50-70), Home & Wellness.` : `Mid-to-high end luxury lifestyle for the whole family — baby (0-3), kids (4-12), teens (13-17), adults (18-50), seniors (50-70), home & wellness.`;
...
function buildCatPage(t, lang, key) {
  ...
  const segs = c.segs.map(([imgKey, name, desc], si) => `
    <div class="seg-block">
...
function buildAI(t, lang) {
  const a = t.ai;
  const diensten = a.diensten.map(([icon, title2, desc]) => `<div class="d-card"><div class="d-icon">${icon}</div><div class="d-title">${title2}</div><div class="d-desc">${desc}</div></div>`).join("");
  const steps = a.steps.map((s, i) => `<div class="step"><div class="sn">${i + 1}</div><div class="st">${s}</div></div>`).join("");
  const body = nav(t, lang, "ai") + `
...
` + foot(t, lang);
  return page(`${lang === "nl" ? "AI Automatisering" : lang === "fr" ? "Automatisation IA" : lang === "de" ? "KI-Automatisierung" : "AI Automation"} | Bierinckx`, a.heroSub, lang, body);
}
...
var worker_default = {
  async fetch(request, env3, ctx) {
    ...
    if (["ai-automatisering", "automatisation-ia", "ai-automation", "ki-automatisierung", "ai"].includes(p))
    ...
    return new Response(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>404</title></head><body style="font-family:system-ui;background:#FAF9F6;display:flex;align-items:center;justify-content:center;min-height:100vh;text-align:center"><div><h1 style="font-weight:300;margin-bottom:1rem">404</h1><a href="/${lang}" style="color:#C9A96E">← Home</a></div></body></html>`, { status: 404, headers: { "Content-Type": "text/html;charset=UTF-8" } });
  }
};
