// BIERINCKX REVENUE AGENCY — CLOUDFLARE WORKER v3.1
// Services sectie compact modern — alle andere wijzigingen behouden
...
const CAT_ICONS = [
  `<svg width="48" height="48" viewBox="0 0 52 52" fill="none"><circle cx="26" cy="20" r="10" fill="#F5F3EE" stroke="#8B1A2B" stroke-width="1.5"/><path d="M14 38c0-6.627 5.373-12 12-12s12 5.373 12 12" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round"/><circle cx="22" cy="18" r="1.5" fill="#8B1A2B"/><circle cx="30" cy="18" r="1.5" fill="#8B1A2B"/><path d="M22 24c1 1.5 3 1.5 4 0" stroke="#8B1A2B" stroke-width="1.2" stroke-linecap="round"/><circle cx="34" cy="8" r="3" fill="#F5F3EE" stroke="#C9A96E" stroke-width="1.2"/></svg>`,
  `<svg width="48" height="48" viewBox="0 0 52 52" fill="none"><circle cx="26" cy="16" r="8" fill="#F5F3EE" stroke="#8B1A2B" stroke-width="1.5"/><path d="M18 36v-6c0-3.314 3.582-6 8-6s8 2.686 8 6v6" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round"/><path d="M18 32l-4 6M34 32l4 6" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round"/><circle cx="22" cy="15" r="1.2" fill="#8B1A2B"/><circle cx="30" cy="15" r="1.2" fill="#8B1A2B"/></svg>`,
  `<svg width="48" height="48" viewBox="0 0 52 52" fill="none"><circle cx="26" cy="15" r="9" fill="#F5F3EE" stroke="#8B1A2B" stroke-width="1.5"/><path d="M17 38v-8a9 9 0 0118 0v8" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round"/><circle cx="22" cy="14" r="1.2" fill="#8B1A2B"/><circle cx="30" cy="14" r="1.2" fill="#8B1A2B"/><path d="M17 8c4-4 10-2 12 0" stroke="#C9A96E" stroke-width="1.2" stroke-linecap="round"/></svg>`,
  `<svg width="48" height="48" viewBox="0 0 52 52" fill="none"><circle cx="26" cy="14" r="9" fill="#F5F3EE" stroke="#8B1A2B" stroke-width="1.5"/><path d="M12 42c0-7.732 6.268-14 14-14s14 6.268 14 14" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round"/><circle cx="22" cy="13" r="1.2" fill="#8B1A2B"/><circle cx="30" cy="13" r="1.2" fill="#8B1A2B"/><path d="M23 18c1.2 1.5 3.6 1.5 4.8 0" stroke="#C9A96E" stroke-width="1.2" stroke-linecap="round"/></svg>`,
  `<svg width="48" height="48" viewBox="0 0 52 52" fill="none"><circle cx="26" cy="14" r="9" fill="#F5F3EE" stroke="#8B1A2B" stroke-width="1.5"/><path d="M14 42c0-7 5.373-12 12-12s12 5 12 12" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round"/><circle cx="22" cy="13" r="1.2" fill="#8B1A2B"/><circle cx="30" cy="13" r="1.2" fill="#8B1A2B"/><path d="M20 40c-2 0-4-1-4-3" stroke="#C9A96E" stroke-width="1" stroke-linecap="round"/></svg>`,
  `<svg width="48" height="48" viewBox="0 0 52 52" fill="none"><path d="M8 26L26 10l18 16" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 22v18h24V22" stroke="#8B1A2B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><rect x="21" y="30" width="10" height="10" rx="1" fill="#F5F3EE" stroke="#8B1A2B" stroke-width="1.2"/><circle cx="38" cy="14" r="2.5" fill="#C9A96E" opacity=".6"/></svg>`
];
...
.sec{padding:4rem 2rem}.sec-alt{background:#fff}
...
.stitle{font-family:'Playfair Display',Georgia,serif;font-size:clamp(1.5rem,3.5vw,2.4rem);font-weight:400;margin-bottom:.6rem}
...
.sc{padding:1.5rem 1.5rem;border-right:1px solid var(--lt);background:var(--cr);transition:all .2s;cursor:pointer;position:relative;border-bottom:2px solid transparent}
.sc:last-child{border-right:none}
.sc:hover{background:var(--iv);border-bottom-color:var(--go)}
.si{font-size:1.25rem;margin-bottom:.6rem;opacity:.7}
.sct{font-size:.88rem;font-weight:600;letter-spacing:.03em;margin-bottom:.4rem;color:var(--bk)}
.scd{font-size:.78rem;color:var(--gr);line-height:1.5;margin-bottom:.75rem}
.sl{font-size:.72rem;color:var(--bu);letter-spacing:.04em}
...
@media(max-width:768px){.nl{display:none}.trust{gap:1.5rem}.g6,.sc2{grid-template-columns:repeat(2,1fr)}.sg{grid-template-columns:repeat(2,1fr)}}
...
function buildShop(t,lang){
  const cats=t.cats.map((c,i)=>`<div class="scat"><div class="scat-icon">${CAT_ICONS[i]}</div><div class="scat-name">${c}</div><div class="scat-desc">${t.catDesc[i]}</div></div>`).join('');
  const body=nav(t,lang,'shop')+`<section class="sec" style="text-align:center"><div class="shop-h"><div class="sb">${lang==='nl'?'Coming Soon':lang==='fr'?'Bient\u00f4t disponible':'Coming Soon'}</div><h1 class="stitle" style="font-family:'Playfair Display',Georgia,serif;margin-bottom:1rem">${lang==='nl'?'Collectie in opbouw':lang==='fr'?'Collection en cours':'Collection coming soon'}</h1><p class="ssub">${lang==='nl'?'Onze premium collectie voor het hele gezin wordt binnenkort gelanceerd.':lang==='fr'?'Notre collection premium sera lanc\u00e9e prochainement.':'Our premium collection will launch soon.'}<br>${lang==='nl'?'Van 0 tot 70 jaar \u00b7 BE / NL / FR':lang==='fr'?'De 0 \u00e0 70 ans \u00b7 BE / NL / FR':'From 0 to 70 years \u00b7 BE / NL / FR'}</p></div><div class="sc2">${cats}</div><div style="margin-top:3rem"><button class="btn bp" onclick="window.location='mailto:auraluxe@bierinckx.com'">auraluxe@bierinckx.com &mdash; ${lang==='nl'?'Vroege toegang':lang==='fr'?'Acc\u00e8s anticip\u00e9':'Early access'}</button></div></section>`+foot(t,lang);
